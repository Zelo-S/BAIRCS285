...
class RL_Trainer(object):
    ...
    def run_training_loop(self, n_iter, collect_policy, eval_policy,
        ...
        # NOTE: added this in custom cuz it wouldn't make sense otherwise
    ...
    def collect_training_trajectories(
        ...
        paths, envsteps_this_batch = utils.sample_trajectories(self.env, collect_policy, batch_size, MAX_VIDEO_LEN) # NOTE: is batch_size == min_timesteps_per_batch?
